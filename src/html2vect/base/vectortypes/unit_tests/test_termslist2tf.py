...
#trms2f_narray(terms_l, tid_vocabulary, norm_func, d2=False, ndtype=np.float32)

    def test_trms2tf_dict_c3grams(self):
    ...
    def test_trms2tf_narray_c3grams(self):
        ...
        for val, exp_val in zip(cngrams_tf_arr, self.expected_c3grams_tf_arr):
    ...
    def test_trms2f_sparse_c3grams(self):
        ...
        for val, exp_val in zip(cngrams_f_sparse.todense(), self.expected_c3grams_f_sparse.todense()):
            self.assertEqual(val[0,0], exp_val[0,0])
    ...
    def test_trms2tf_narray_words(self):
        ...
        for val, exp_val in zip(words_tf_arr, self.expected_words_tf_arr):
            self.assertEqual(val, exp_val)
