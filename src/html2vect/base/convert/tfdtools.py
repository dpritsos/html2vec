...
""" html2vect.base.convert.tfdtools: submodule of `html2vect` module defines the class TFDictTools """


class TFDictTools(object):
    
    def __init__(self):
        pass
    
    
    def merge_tfds(self, *terms_d):
    ...
    def merge_tfds_frmlist(self, tf_d_l):
